//
//  IcecreamSundaeSugarViewController.m
//  Frozen Treats
//
...
@implementation IcecreamSundaeSugarViewController
@synthesize flavor;

- (id)init
{
    if([[UIScreen mainScreen] bounds].size.height == 568)
        self = [super initWithNibName:@"IcecreamSundaeSugarViewController-5" bundle:[NSBundle mainBundle]];
    else
        self = [super init];
...
//    accelerometer.delegate = nil;
    ...
    IcecreamSundaeMilkViewController *icecreamMilk = [[IcecreamSundaeMilkViewController alloc] init];
    icecreamMilk.flavor = flavor;
    [self.navigationController pushViewController:icecreamMilk animated:NO];
    [icecreamMilk release];
}
