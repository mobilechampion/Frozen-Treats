...
- (void)start
{
	self.clockUpdateTimer = [NSTimer scheduledTimerWithTimeInterval:0.5 target:self selector:@selector(updateClockTimeAnimated:) userInfo:nil repeats:YES];
...
- (void)updateHoursHand
{
  ...
  int degreesPerHour   = 5;
  int degreesPerMinute = 10;
